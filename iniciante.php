...
<script type="text/javascript">
	...
	var simbolos = {cobre:"Cu", uranio:"U", mercurio:"Hg", boro:"B", cloro:"Cl", prata:"Ag", calcio:"Ca", nitrogenio:"N", oxigenio:"O", ferro:"Fe", silicio:"Si", carbono:"C", sodio:"Na", ouro:"Au", helio:"He"};
	...
	<div class="row">
        ...
        <div class="col-2">
            ...
            <div class="row justify-content-center">
				...
				echo '	<div class="jogador-info"> <div class="jogador">
							...
							<div class="nomeNivel">NÍVEL: INICIANTE</div>
        ...
        <div class="tabela col-7">
             ...
             <div class="row justify-content-center">
                ...
                <button onclick="verificar(value)" value="hidrogenio" class="quadrado text-xl-center"id="hidrogenio">s<div class="propriedadeselemento"></div></button>
               ...
               <div class="espaco-branco numerosHorizontais" >13</div>
                ...
                <button onclick="verificar(value)" value="helio" class="quadrado" id="helio">p<div class="propriedadeselemento"></div></button>
            
            </div>

             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" >2</div>
                <button onclick="verificar(value)" class="quadrado">s<div class="propriedadeselemento"></div></button>
                ...
                <button onclick="verificar(value)" id="boro" value="boro" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="carbono" value="carbono"class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="nitrogenio" value="nitrogenio" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="oxigenio" value="oxigenio"class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="fluor" value="fluor" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">p<div class="propriedadeselemento"></div></button>
            </div>    

            
             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" >3</div>
                <button onclick="verificar(value)" id="sodio" value="sodio" class="quadrado">s<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="magnesio" value="magnesio" class="quadrado">s<div class="propriedadeselemento"></div></button>
                ...
                <button onclick="verificar(value)" id="aluminio" value="aluminio" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="silicio" value="silicio" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="enxofre" value="enxofre" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="cloro" value="cloro" class="quadrado">p<div class="propriedadeselemento"></div></button>
             ...
             <div class="row justify-content-center">
                ...
                <button onclick="verificar(value)" id="potassio" value="potassio" class="quadrado">s<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="calcio" value="calcio" class="quadrado">s<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="titanio" value="titanio" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="manganes" value="manganes" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="ferro" value="ferro" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="cobre" value="cobre" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="zinco" value="zinco" class="quadrado">d<div class="propriedadeselemento"></div></button>
                ...
                <button onclick="verificar(value)" id="criptonio" value="criptonio" class="quadrado">p<div class="propriedadeselemento"></div></button>
             ...
             <div class="row justify-content-center">
                ...
                <button onclick="verificar(value)" id="prata" value="prata" class="quadrado">d<div class="propriedadeselemento"></div></button>
                ...
                <button onclick="verificar(value)" id="iodo" value="iodo" class="quadrado">p<div class="propriedadeselemento"></div></button>
             ...
             <div class="row justify-content-center">
                ...
                <button onclick="verificar(value)" id="osmio" value="osmio" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="platina" value="platina"class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="ouro" value="ouro" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="mercurio" value="mercurio" class="quadrado">d<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">p<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="chumbo" value="chumbo" class="quadrado">p<div class="propriedadeselemento"></div></button>
             ...
             <div class="row justify-content-center">
                ...
                <button onclick="verificar(value)" id="lantanio" value="lantanio" class="quadrado">f<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">f<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">f<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">f<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="promecio" value="promecio" class="quadrado">f<div class="propriedadeselemento"></div></button>
             ...
             <div class="row justify-content-center">
                ...
                <button onclick="verificar(value)" id="actinio" value="actinio" class="quadrado">f<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">f<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" class="quadrado">f<div class="propriedadeselemento"></div></button>

                <button onclick="verificar(value)" id="uranio" value="uranio" class="quadrado">f<div class="propriedadeselemento"></div></button>
            ...
            <div class="col-3">
               	<div class="row justify-content-center">
					...
					<?php
						...
						$sql = "SELECT resposta FROM bigbang_questao WHERE codNivel = 1 ORDER BY rand() LIMIT 12";
						...
						<?php 
							...
							if ($x == 1) {
								...
								<button class='element' value='$fig1' id='fig1' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f1' src='img/elementos/$fig1.jpg' width='45' height='55'></button>

								<button class='element' value='$fig2' id='fig2' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f2' src='img/elementos/$fig2.jpg' width='45' height='55'></button>

								<button class='element' value='$fig3' id='fig3' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f3' src='img/elementos/$fig3.jpg' width='45' height='55'></button>

								<button class='element' value='$fig9' id='fig9' onclick='window.salvarElemento(value, id)' ><img class='figura' src='img/elementos/$fig9.jpg' width='45' height='55'></button>

								<button class='element' value='$fig4' id='fig4' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f4' src='img/elementos/$fig4.jpg' width='45' height='55'></button>

								<button class='element' value='$fig10' id='fig10' onclick='window.salvarElemento(value, id)' ><img class='figura' src='img/elementos/$fig10.jpg' width='45' height='55'></button>

								<button class='element' value='$fig5' id='fig5' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f5' src='img/elementos/$fig5.jpg' width='45' height='55'></button>

								<button class='element' value='$fig11' id='fig11' onclick='window.salvarElemento(value, id)' ><img class='figura' src='img/elementos/$fig11.jpg' width='45' height='55'></button>

								<button class='element' value='$fig6' id='fig6' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f6' src='img/elementos/$fig6.jpg' width='45' height='55'></button>

								<button class='element' value='$fig7' id='fig7' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f7' src='img/elementos/$fig7.jpg' width='45' height='55'></button>

								<button class='element' value='$fig12' id='fig12' onclick='window.salvarElemento(value, id)' ><img class='figura' src='img/elementos/$fig12.jpg' width='45' height='55'></button>

								<button class='element' value='$fig8' id='fig8' onclick='window.salvarElemento(value, id)' ><img class='figura' id='f8' src='img/elementos/$fig8.jpg' width='45' height='55'></button>
		...
		if (semDicas == 1){
			...
			if ((contRodada == 8) && (validacao == 1)) {
				...
				if (listaElemento == fig1) {
					...
					document.getElementById('distrib').src = "img/distribuicao/"+listaElemento+".png";
					...
					document.getElementById('distrib').src = "img/distribuicao/fundo.png";
			...
			// CRIA HTML DINÂNICO COM MODAL.
				...
				nivel.setAttribute('value', 'INICIANTE');
