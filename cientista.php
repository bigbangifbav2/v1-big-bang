...
<html>
	...
	<head>
		...
		<script type="text/javascript">
			...
			var simbolos = {zinco:"Zn", bromo:"Br", bario:"Ba", polonio:"Po", estanho:"Sn", titanio:"Ti", promecio:"Pm", chumbo:"Pb", cromo:"Cr", osmio:"Os", hidrogenio:"H", manganes:"Mn", niquel:"Ni", criptonio:"Kr", fosforo:"P"};
	...
	<body>
            ...
            <div class="row justify-content-center">
				...
				<?php
					...
					echo '	<div class="jogador-info"> <div class="jogador">
							...
							<div class="nomeNivel">NÍVEL: CIENTISTA</div>
		...
		<div class="tabela col-7">
                ...
                <div class=" numVertical numerosHorizontais" style="color:transparent";" ></div>
                
                <div class="espaco-branco numerosHorizontais " style="color:transparent"; > 1</div>
                ...
                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >18</div>

            </div>

             <div class="row justify-content-center">

                <div class=" numVertical numerosHorizontais" style="color:transparent";" >1</div>
                ...
                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >2</div>
               ...
               <div class="espaco-branco numerosHorizontais " style="color:transparent"; >13</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >14</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >15</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >16</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >17</div>
             ...
             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" style="color:transparent";" >2</div>
             ...
             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" style="color:transparent";" >3</div>
                ...
                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >3</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >4</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >5</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >6</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >7</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >8</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >9</div>
                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >10</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >11</div>

                <div class="espaco-branco numerosHorizontais " style="color:transparent"; >12</div>
             ...
             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" style="color:transparent";" >4</div>
             ...
             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" style="color:transparent";" >5</div>
             ...
             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" style="color:transparent";" >6</div>
                <button onclick="verificar(value)" class="quadrado"><div class="propriedadeselemento"></div></button>
             ...
             <div class="row justify-content-center">
                <div class=" numVertical numerosHorizontais" style="color:transparent";" >7</div>
                <button onclick="verificar(value)" class="quadrado"><div class="propriedadeselemento"></div></button>
        	...
        	<div class="col-3">
               	<div class="row justify-content-center">
					...
					<?php
						...
						$sql = "SELECT resposta FROM bigbang_questao WHERE codNivel = 3 ORDER BY rand() LIMIT 12";
		...
		function salvarElemento (value, id) {
			 ...
			 if (semDicas == 1){
				...
				// CRIA HTML DINÂNICO COM MODAL.
					...
					nivel.setAttribute('value', 'CIENTISTA');
